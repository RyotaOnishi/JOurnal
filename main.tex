...
まず，解析時の最適な移動窓幅の大きさ$W$を決定するために，全被験者に対してモデルの適合性を表すBIC (Bayesian information criterion)を$W = {10,15,20,25,30}$と変更させて算出し，ずらし幅$S$は，$S = 1$ sとした．
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.9\hsize]{figure/Estimate_parameter.eps}
%\end{center}
